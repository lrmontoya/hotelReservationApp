...
public class AdminResource {
    ...
    public static AdminResource instanceAdminResource = null;
    ...
    public static AdminResource getInstance(){
        if (instanceAdminResource ==  null) {
            instanceAdminResource = new AdminResource();
        }
        return instanceAdminResource;
    }
